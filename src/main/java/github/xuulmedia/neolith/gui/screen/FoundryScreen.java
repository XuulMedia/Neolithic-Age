...
public class FoundryScreen extends AbstractContainerScreen<github.xuulmedia.neolith.gui.menu.FoundryMenu> {
    ...
    public FoundryScreen(github.xuulmedia.neolith.gui.menu.FoundryMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
