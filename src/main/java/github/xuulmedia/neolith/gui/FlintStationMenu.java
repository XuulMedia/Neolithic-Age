...
public class FlintStationMenu extends AbstractContainerMenu {
    ...
    private void setupRecipeList(Container pInventory, ItemStack pStack) {
        ...
        if (!pStack.isEmpty()) {
            this.recipes = this.level.getRecipeManager().getRecipesFor(FlintStationRecipe.Type.INSTANCE, pInventory, this.level);
        }
    }
    ...
    public ItemStack quickMoveStack(Player pPlayer, int pIndex) {
        ...
        if (slot != null && slot.hasItem()) {
            ...
            } else if (this.level.getRecipeManager().getRecipeFor(FlintStationRecipe.Type.INSTANCE, new SimpleContainer(itemstack1), this.level).isPresent()) {
