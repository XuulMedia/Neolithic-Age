...
import github.xuulmedia.neolith.recipe.ToolUseRecipe;
...
public class ToolUseRecipeBuilder extends ShapelessRecipeBuilder {
    ...
    public ToolUseRecipeBuilder(ItemLike result, int count) {
        super(RecipeCategory.TOOLS, result, count);
    ...
    @Override
    public void save(Consumer<FinishedRecipe> finishedRecipeConsumer, ResourceLocation pRecipeId) {
        ...
        finishedRecipeConsumer.accept(new ShapelessRecipeBuilder.Result(pRecipeId,
                this.result,
                this.count,
                this.group == null ? "" : this.group,
                determineBookCategory(RecipeCategory.TOOLS),
                this.ingredients, this.advancement,
                pRecipeId.withPrefix("recipes/" + RecipeCategory.TOOLS.getFolderName() + "/")));
    }
    ...
    public static class Result implements FinishedRecipe {
        ...
        public void serializeRecipeData(JsonObject pJson) {
            ...
            jsonobject2.addProperty("tool",  BuiltInRegistries.ITEM.getKey(this.result).toString());
