...
public class FoundryRecipeBuilder implements RecipeBuilder {
    ...
    public FoundryRecipeBuilder(Ingredient input, Item result, int count, int heat) {
        this.input = input;
        this.result = result;
        this.count = count;
        this.heat = heat;
    ...
    public static class Result implements FinishedRecipe {
        ...
        public Result(ResourceLocation id, String group, Ingredient input, Item result, int count, int heat,
        ...
        public void serializeRecipeData(JsonObject pJson) {
            ...
            pJson.addProperty("output", BuiltInRegistries.ITEM.getKey(this.result).toString());
