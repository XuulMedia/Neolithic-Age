...
public class HeatingFuelRecipeBuilder implements RecipeBuilder {
    ...
    public HeatingFuelRecipeBuilder(Ingredient input, int heat, int burnTime) {
        this.input = input;
        this.heat = heat;
    ...
    public static class Result implements FinishedRecipe {
        ...
        public RecipeSerializer<?> getType() {
            return HeatingFuelRecipe.SERIALIZER;
        }
