...
public class FoundryFuelRecipe implements Recipe<Container> {
    ...
    public static class Type implements RecipeType<FoundryFuelRecipe> {
        private Type() { }
        public static final FoundryFuelRecipe.Type INSTANCE = new FoundryFuelRecipe.Type();
        public static final String ID = "foundry_fuel";
    }
