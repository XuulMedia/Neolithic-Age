...
import xuul.flint.gui.slot.ModResultSlot;
...
public class FoundryMenu extends AbstractContainerMenu {
    ...
    public FoundryMenu(int windowId, Inventory inventory, BlockEntity tile, ContainerData data) {
        ...
        this.fuels = recman.getAllRecipesFor(FoundryFuelRecipe.TYPE);
        this.recipes = recman.getAllRecipesFor(FoundryRecipe.TYPE);
    }
