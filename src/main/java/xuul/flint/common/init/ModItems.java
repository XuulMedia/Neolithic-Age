...
//    Items
    ...
    public static final  RegistryObject<Item> ORE_TIN_ITEM = itemFromBlock(ModBlocks.ORE_TIN, STANDARD_METAL_AGE_PROPERTIES);
    public static final  RegistryObject<Item> ORE_SILVER_ITEM = itemFromBlock(ModBlocks.ORE_SILVER, STANDARD_METAL_AGE_PROPERTIES);

    public static final  RegistryObject<Item> BLOCK_TIN_ITEM = itemFromBlock(ModBlocks.BLOCK_TIN, STANDARD_METAL_AGE_PROPERTIES);
    public static final  RegistryObject<Item> BLOCK_SILVER_ITEM = itemFromBlock(ModBlocks.BLOCK_SILVER, STANDARD_METAL_AGE_PROPERTIES);
    public static final  RegistryObject<Item> BLOCK_BRONZE_ITEM = itemFromBlock(ModBlocks.BLOCK_BRONZE, STANDARD_METAL_AGE_PROPERTIES);
    public static final  RegistryObject<Item> BLOCK_STEEL_ITEM = itemFromBlock(ModBlocks.BLOCK_STEEL, STANDARD_METAL_AGE_PROPERTIES);


    public static final  RegistryObject<Item> COBBLESTONE_ITEM = itemFromBlock(ModBlocks.COBBLESTONE, STANDARD_STONE_AGE_PROPERTIES);
    public static final  RegistryObject<Item> BASTALT_COBBLESTONE_ITEM = itemFromBlock(ModBlocks.BASALT_COBBLESTONE, STANDARD_STONE_AGE_PROPERTIES);
    public static final  RegistryObject<Item> DEEPSLATE_COBBLESTONE_ITEM = itemFromBlock(ModBlocks.DEEPSLATE_COBBLESTONE, STANDARD_STONE_AGE_PROPERTIES);
    public static final  RegistryObject<Item> NETHERRACK_COBBLESTONE_ITEM = itemFromBlock(ModBlocks.NETHERRACK_COBBLESTONE, STANDARD_STONE_AGE_PROPERTIES);
    public static final  RegistryObject<Item> SANDSTONE_COBBLESTONE_ITEM = itemFromBlock(ModBlocks.SANDSTONE_COBBLESTONE, STANDARD_STONE_AGE_PROPERTIES);
    public static final  RegistryObject<Item> BLACKSTONE_COBBLESTONE_ITEM = itemFromBlock(ModBlocks.BLACKSTONE_COBBLESTONE, STANDARD_STONE_AGE_PROPERTIES);
    public static final  RegistryObject<Item> ENDSTONE_COBBLESTONE_ITEM = itemFromBlock(ModBlocks.ENDSTONE_COBBLESTONE, STANDARD_STONE_AGE_PROPERTIES);
    public static final  RegistryObject<Item> GRANITE_COBBLESTONE_ITEM = itemFromBlock(ModBlocks.GRANITE_COBBLESTONE, STANDARD_STONE_AGE_PROPERTIES);
    public static final  RegistryObject<Item> TUFF_COBBLESTONE_ITEM = itemFromBlock(ModBlocks.TUFF_COBBLESTONE, STANDARD_STONE_AGE_PROPERTIES);
    public static final  RegistryObject<Item> ANDESITE_COBBLESTONE_ITEM = itemFromBlock(ModBlocks.ANDESITE_COBBLESTONE, STANDARD_STONE_AGE_PROPERTIES);
    public static final  RegistryObject<Item> DIORITE_COBBLESTONE_ITEM = itemFromBlock(ModBlocks.DIORITE_COBBLESTONE, STANDARD_STONE_AGE_PROPERTIES);
