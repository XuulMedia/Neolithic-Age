...
public class ModBlocks {
    ...
    public static final RegistryObject<FallingBlock> COBBLESTONE = BLOCKS.register("cobblestone",
    ...
    /*Stone Brick*/
    public static final RegistryObject<FallingBlock> STONE_BRICK_BLOCK = BLOCKS.register("stone_brick_block",
        () -> new FallingBlock(BlockBehaviour.Properties.of(Material.STONE)
            .requiresCorrectToolForDrops()
            .strength(1.5F, 6.0F)
            .isValidSpawn(Blocks::never)
