...
import xuul.flint.common.gui.FoundryMenu;

public class FoundryRecipe implements Recipe<Container> {
    public static final RecipeType<FoundryRecipe> TYPE = RecipeType.register(Flint.MOD_ID + ":foundry");
    ...
    private static class Serializer extends ForgeRegistryEntry<RecipeSerializer<?>> implements RecipeSerializer<FoundryRecipe> {
        Serializer() {
            // this.setRegistryName(new ResourceLocation(Flint.MOD_ID, "foundry"));
        }
