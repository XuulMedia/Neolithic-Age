...
public class FoundryFuelRecipe implements Recipe<Container> {
    ...
    private static class Serializer extends ForgeRegistryEntry<RecipeSerializer<?>> implements RecipeSerializer<FoundryFuelRecipe> {
        Serializer() {
            // this.setRegistryName(new ResourceLocation(Flint.MOD_ID, "foundry_fuel"));
        }
